...
@Component({
  selector: 'app-hospital-register-file-form',
  templateUrl: './hospital-register-file-form.component.html',
  styleUrls: ['./hospital-register-file-form.component.scss']
})
export class HospitalRegisterFileFormComponent implements OnInit{
  ...
  formSubmit() {
    ...
    this.form.FormGroup.get('hospital_id')?.setValue(this.id);
    if (this.form.FormGroup.valid) {
      ...
      formData.append('hospital_id', this.form.FormGroup.get('hospital_id')?.value);
      ...
      this._hospitalService.uploadImage(formData).subscribe({
        next: (resp: any) => {
